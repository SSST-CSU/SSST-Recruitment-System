"""
Django settings for SSCUST project.
...
SECRET_KEY = 'ryl)4p9n@-am!w39$+4*(esa77%pcizf71=srdp^9@b(#!%(%4'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'eva/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'SSCUST.wsgi.application'
